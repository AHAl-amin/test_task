...
export default function RootLayout({ children }) {
  return (
    ...
    style={{ backgroundImage: `url(${bg.src})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      <body className={`${inter.variable} ${poppins.variable} h-screen overflow-hidden text-foreground max-w-[1440px] mx-auto flex flex-col`}>
        ...
        <div className="flex flex-1 overflow-hidden gap-6">
          <Sidebar />
          <main className="flex-1 overflow-y-auto  pt-2 scroll-smooth hide-scrollbar relative">
            {children}
          </main>
        </div>
      </body>
