    ...
    >
      <body className="relative w-screen overflow-x-hidden bg-linear-to-tr from-[#CBE1FF]/50 via-[#E7F2F5] to-[#E7F2F5]">
        <div className={` text-foreground max-w-[1440px] mx-auto 2xl:px-0 xl:px-4 px-4 flex flex-col `}>
          <div className='absolute -top-50 -right-32 rounded-full bg-radial from-[#BAD1FF] via-[#BAD1FF]/10 to-transparent w-[1000px] h-[1000px]'></div>
          <div className='absolute top-[12%] -left-[300px] rounded-full bg-radial from-[#CBE1FF] via-[#CBE1FF]/20 to-transparent w-[700px] h-[900px]'></div>
          <div className='absolute top-[12%] -right-[200px] rounded-full bg-radial from-[#AFF4FA] via-transparent to-transparent w-[1200px] h-[1600px]'></div>
          <Navbar />
