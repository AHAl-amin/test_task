...
const Navbar = () => {
    return (
        <header className="py-2">
            {/* Left : Welcome Text */}
            <div className="lg:h-[88px] h-[68px]  flex items-center justify-between    backdrop-blur-sm sticky top-0 z-40">
                <div className="flex items-center gap-12 ">
                    <div className=" ml-4">
                        <Image src={logo} width={32} height={28} alt="Logo" />
                    </div>
                    <div className="text-[16px] font-medium text-[#000000]">
                        <h1 className="text-[16px] -mb-[6px] ">Welcome Back, Mark</h1>
                        <p className="text-sm text-[#00000066]/60 font-medium mt-1">
                            Overview: <span className="text-[#000000] text-[16px]">Athlete Program Dashboard</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-6 h-full ">
                    {/* Search */}
                    <div className="relative group h-full text-gray-400">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <Search className="h-4 w-4   transition-colors" />
                        </div>
                        <input
                            type="text"
                            className="block w-[402px] h-full pl-10 pr-3 py-2.5 border-x border-[#FFFFFFE5] bg-[#ffffff62] leading-5  text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:bg-[#ffffffa6] transition-all placeholder:text-[#00000099]/60 "
                            placeholder="Search "
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-3 h-full  ">
                        <div className="border-l  border-[#00000021] pl-6">
                    ...
                    <div className="flex items-center gap-3 pl-2">
                        <div className="w-10 h-10 rounded-full overflow-hidden  shadow-md cursor-pointer hover:ring-2 hover:ring-blue-200 transition-all">
