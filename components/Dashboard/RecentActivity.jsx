...
const ActivityItem = ({ icon: Icon, title, description, time, type }) => {
    return (
        <div className="flex gap-3 py-3 px-3  rounded-xl transition-all duration-300 hover:bg-white/40 cursor-default">
            <div className="flex-shrink-0">
                <div className={` w-10 h-10 rounded-full flex items-center justify-center text-blue-500
                     ${type === "feedback" ? "bg-[#FFFFFF91]" : "bg-[#FFFFFF]"}`}>
                    {type === "feedback" ? (
...
const RecentActivity = () => {
    return (
        <div className="px-5 py-3 rounded-[24px]   bg-white/20 backdrop-blur-sm border border-gray-100 h-fit">
            <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <button className="px-5 py-[10px] text-[10px] font-medium bg-linear-to-b from-[#5C8FF7] to-[#276AEE] text-[#FFFFFF] rounded-full shadow-md shadow-blue-200 cursor-pointer">
                        View More
                    </button>
                </div>
            </div>
