        ...
        <div className="flex gap-4 mb-6 last:mb-0">
            <div className="flex-shrink-0">
                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-500">
                    {/* Using a generic icon if specific one not passed, or relying on the passed Icon */}
                    {/* In design, they are simple shapes or icons */}
                    <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[10px] border-t-blue-500"></div>
                </div>
            </div>
            <div className="flex-1">
                ...
                {type === "feedback" && (
                    <button className="mt-2 px-3 py-1 bg-blue-500 text-white text-[10px] font-bold rounded-full">
                        View Feedback
                    </button>
                )}
            </div>
        ...
        <div className="mb-6 bg-blue-50/50 p-6 rounded-[2rem] border border-blue-100">
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                    ...
                    <button className="px-3 py-1 bg-blue-500 text-white text-xs font-bold rounded-full shadow-md shadow-blue-200">
                        View More
                    </button>
                </div>
            </div>
