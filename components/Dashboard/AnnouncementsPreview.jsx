...
import { Heart, MessageSquare, Reply, Share2, MoreVertical, PlayCircle } from "lucide-react";
        ...
        <div className="mb-8">
            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                ...
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=2574&auto=format&fit=crop" alt="Sam Guy" className="w-full h-full object-cover" />
                        </div>
                        <div>
                ...
                <div className="mb-4">
                    ...
                    <div className="relative w-full h-48 rounded-xl overflow-hidden bg-black group cursor-pointer">
                        {/* Thumbnail */}
                        <div className="absolute inset-0 bg-cover bg-center opacity-80" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=2670&auto=format&fit=crop")' }}></div>
            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 mt-6">
                ...
                <div className="mb-4">
                    ...
                    <div className="relative w-full h-40 rounded-xl overflow-hidden bg-blue-50">
                        {/* Map Placeholder */}
                        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=2674&auto=format&fit=crop")' }}></div>
                        <div className="absolute inset-0 flex items-center justify-center">
